...
from echoline import text_utils
from echoline.dependencies import (
    CompletionClientDependency,
    SpeechClientDependency,
    TranscriptionClientDependency,
)
from echoline.text_utils import SentenceChunker, format_as_sse
from echoline.types.chat import (
...
async def handle_completions(
    ...
    try:
        ...
        logger.exception(
            f"Echoline API proxy error: {error_message} | "
        ...
        raise APIProxyError(
            ...
            suggestions=[
                ...
                "Ensure the endpoint URL matches your Echoline server configuration.",
                "Test your internet connection.",
                "If the error persists, visit https://github.com/vowel/echoline/issues or contact support with the error ID.",
            ],
            debug=error_info,
        ) from e
        ...
        logger.exception(f"Echoline unexpected error: {error_message} | exception_type={error_info['exception_type']}")
        raise APIProxyError(
            error_message,
            status_code=500,
            ...
            suggestions=[
                "Retry your request.",
                "If the error persists, visit https://github.com/vowel/echoline/issues or contact support and provide the debug information.",
            ],
            debug=error_info,
        ) from e
