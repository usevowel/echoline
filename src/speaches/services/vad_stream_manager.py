...
from speaches.executors.silero_vad_v5 import MODEL_ID, SileroVADModelManager, VadOptions
from speaches.schemas.vad_stream import VADStreamOptions

if TYPE_CHECKING:
    from speaches.schemas.vad_stream import VADStreamEvent
